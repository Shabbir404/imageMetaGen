    ...
    >
      ...
      <button
        ...
        style={{
          ...
          cursor: "pointer",
          marginBottom: 8,
          boxShadow: "0 3px 12px rgba(167,139,250,0.18)",
        }}
      >
      ...
      >
        {keys.length === 0
          ? "no keys loaded"
          : `${readyKeys} of ${keys.length} ready`}
      </div>

      <Slider
        label="Title Length"
        value={settings.titleLen}
        min={20}
        max={200}
      ...
      <Field label="Content Type">
        <select
          ...
          onChange={(e) =>
            setSettings((s) => ({ ...s, contentType: e.target.value }))
          }
          style={selectStyle}
        >
      ...
      <div style={{ marginTop: 4 }}>
        ...
        {settings.customPrompt && (
          <button
            onClick={() => setSettings((s) => ({ ...s, customPrompt: "" }))}
            style={{
              background: "none",
              border: "none",
              color: "var(--text-faint)",
