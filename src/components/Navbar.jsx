      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
        <a
          ...
          style={{
            ...
            color: 'var(--text-dim)', textDecoration: 'none', border: '1px solid var(--line)',
...
function NavItem({ label, active }) {
  return (
    <a href="#" onClick={e => e.preventDefault()} style={{
      ...
      textDecoration: 'none', color: active ? 'var(--text)' : 'var(--text-dim)',
      background: active ? 'var(--bg-inset)' : 'transparent',
      border: active ? '1px solid var(--line-bright)' : '1px solid transparent'
    }}>
      {label}
    </a>
  );
